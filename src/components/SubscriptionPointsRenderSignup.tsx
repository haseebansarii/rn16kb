...
const SubscriptionPointsRenderSignup = ({
  plan,
  SubscriptionTime,
  titleColor,
}: Props) => {
  ...
  const renderCheckIcon = () => {
    return <Images.svg.CheckCustom.default style={{color: titleColor}} />;
  };
  ...
  return (
    <View
      ...
      {plan?.unlimited_selling ||
        (plan?.unlimited_general_selling && (
          <View
            style={[
              Layout.row,
      ...
      {plan?.unlimited_selling || plan?.unlimited_vehicle_selling ? (
        <View
          style={[Layout.row, Gutters.littleTMargin, Layout.alignItemsCenter]}>
          {renderCheckIcon()}
          <Text
...
export default SubscriptionPointsRenderSignup;
